...
Premendo il pulsante *Setting* in basso a sinistra dello schermo si aprirà il pannello mostrato in @impostazioni (sinistra).

In alto troviamo *Informazioni*, contenente varie informazioni riguardo il prodotto.

Nella sezione subito sottostante troviamo *Planimetria* con riportati i valori dimensionali del piano, qui è possibile, cliccando sui valori mostrati, ridimensionarne le dimensioni.
...
- *Risincronizza* che permette riportare il piano al suo stato iniziale, eliminando quindi tutte le zone create e gli spostamenti effettuati;
- *Reinposta* che permette di eliminare tutto il lavoro fatto sul piano e tornare alla schermata di @avvio.
