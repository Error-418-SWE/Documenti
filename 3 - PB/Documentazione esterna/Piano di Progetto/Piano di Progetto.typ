...
- scelta di una data per un eventuale primo meeting con il #cardin per ottenere un feedback sull'Analisi dei Requisiti;
...
- svolgere meeting con il #cardin in merito all'Analisi dei Requisiti;
...
- adeguare l'Analisi dei Requisiti in funzione di quanto emerso durante lo scorso meeting con il #cardin;
...
=== Obiettivi prefissati
Il feedback ricevuto dopo il colloquio RTB con il #cardin ha evidenziato la necessità di una profonda revisione del documento di Analisi dei Requisiti, che pertanto è il focus principale di questo sprint. Gli obiettivi prefissati per questo sprint sono:
...
=== Problematiche
Il feedback ricevuto dal #cardin evidenzia diverse lacune nel documento Analisi dei Requisiti. Sarà dunque necessario investire risorse per correggere e migliorare il documento. Ciò potrebbe influire negativamente sull'avanzamento del progetto.
