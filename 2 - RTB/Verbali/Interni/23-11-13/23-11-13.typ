...
#show: project.with(
  ...
  partecipants: (
    ...
    //(name: "Pippo",  role: "Proponente"),
  ),
  oraInizio: "15:30",
  oraFine:  "17:30",
  firmeEsterne: "///inserire firma esterna///"   //Questa variabile va aggiunta solo se è un documento esterno, qua i partecipanti esterni andranno a firmarsi.
)
