...
- le ore di Analista sono state maggiori di quanto preventivato: il tracciamento UC - requisiti, per renderlo uniforme, automatico e facilmente estendibile è stato implementato mediante un automazione direttamente nei documenti in Typst e l'estensione dell'UC 7 ha richiesto più tempo del previsto;
