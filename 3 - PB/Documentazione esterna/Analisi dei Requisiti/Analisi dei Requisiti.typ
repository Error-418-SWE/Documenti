...
#figure(
  table(
    ...
    align: left,
    [*Codice*], [*Classificazione*], [*Descrizione*], [*Riferimento*],
    [QM-1], [Obbligatorio], [Deve essere rispettato quanto previsto dalle #ndp], [Decisione\ interna],
    [QM-2], [Obbligatorio], [Deve essere rispettato quanto previsto dal #pdq], [Decisione\ interna],
