...
- To do:
  - definire con precisione dei parametri per il controllo dello "scaling" dell'applicazione;
  - fissare parametri precisi per l'ambiente di default dell'applicazione;
