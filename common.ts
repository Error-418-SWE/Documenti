export namespace Common {
	export const name:string = 'Error_418';
	...
	export const universityName:string = 'Università degli Studi di Padova';
	export const universityMinor:string = 'Informatica';
	export const universityCourse:string = 'Ingegneria del Software';
};